    ...
    return (
        <FormWrapper>
            ...
            <Form onSubmit={handleSubmit}>
                <Lable>URL</Lable>
                <Input type="text" id="destinationUrl" pattern="/^https?:\/\/\S+$/i" title="Please enter a valid URL." name="destinationUrl" value={formData.destinationUrl} onChange={handleChange} placeholder="Enter URL" />
                <Lable>Alias</Lable>
